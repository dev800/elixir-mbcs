...
%%
%% @doc Start mbcs_erl server, Return {ok, Pid}.
...
encode(Unicode, Encoding, Options) ->
    try
        gen_server:call(mbcs_erl_server, {encode, Unicode, Encoding, Options})
    catch
        throw:_ ->
            {error, unkonwn_error};
        exit:_ ->
...
decode(StringOrBinary, Encoding, Options) ->
    try
        gen_server:call(mbcs_erl_server, {decode, StringOrBinary, Encoding, Options})
    catch
        throw:_ ->
            {error, unkonwn_error};
        exit:_ ->
...
from_to(StringOrBinary, InputEncoding, OutputEncoding, Options) ->
    try
        gen_server:call(mbcs_erl_server, {from_to, StringOrBinary, InputEncoding, OutputEncoding, Options})
    catch
        throw:_ ->
            {error, unkonwn_error};
        exit:_ ->
